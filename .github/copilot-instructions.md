1.port the flipper zero predator-security-suite to work on the mayhem-mdk module which is an addon board for the hack-rf portapack h4m with mayhem-firmware.

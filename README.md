...
This software is a **TOOL** - like a hammer, it can be used constructively or destructively. The responsibility for its use lies **ENTIRELY WITH THE USER**.
